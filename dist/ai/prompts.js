...
exports.buildPokerPrompt = buildPokerPrompt;
const soul_1 = require("./soul");
function buildPokerPrompt(state, myId, soul) {
    ...
    const communityStr = state.communityCards.length > 0
