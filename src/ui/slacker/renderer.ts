...
export class SlackerRenderer {
  private screen: blessed.Widgets.Screen;
  private codeBox: blessed.Widgets.BoxElement;
  private pokerBox: blessed.Widgets.BoxElement;
  ...
  private showRaisePrompt(): void {
    ...
    prompt.readInput('金额:', '', (err: any, value: string) => {
      if (!err && value) {
